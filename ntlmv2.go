...
func (n *V2ServerSession) GenerateChallengeMessage() (cm *ChallengeMessage, err error) {
	...
	pairs := new(AvPairs)
	pairs.AddAvPair(MsvAvNbDomainName, utf16FromString("JBVM"))
	pairs.AddAvPair(MsvAvNbComputerName, utf16FromString("GAWA-TBCRTME07"))
	pairs.AddAvPair(MsvAvDnsDomainName, utf16FromString("jbvm.io"))
	pairs.AddAvPair(MsvAvDnsComputerName, utf16FromString("gawa-usa.jbvm.io"))
	pairs.AddAvPair(MsvAvDnsTreeName, utf16FromString("jbvm.io"))
